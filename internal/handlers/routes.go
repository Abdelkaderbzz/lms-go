...
func SetupRoutes(router *gin.Engine, db *gorm.DB) {
	...
	protected.Use(middleware.AuthMiddleware())
	{
		...
		courses := protected.Group("/courses")
		{
			...
			// Assignment routes - combine all operations under single /assignments/:id
			courses.POST("/assignments/:id/submit", middleware.RoleMiddleware(models.RoleStudent), func(c *gin.Context) { SubmitAssignment(c, db) })
			courses.GET("/assignments/:id/submissions", middleware.RoleMiddleware(models.RoleInstructor, models.RoleAdmin), func(c *gin.Context) { GetAssignmentSubmissions(c, db) })
			courses.GET("/assignments/:id/my-submission", middleware.RoleMiddleware(models.RoleStudent), func(c *gin.Context) { GetStudentSubmission(c, db) })
			...
			// Quiz routes - combine all operations under single /quizzes/:id
			courses.POST("/quizzes/:id/questions", middleware.RoleMiddleware(models.RoleInstructor, models.RoleAdmin), func(c *gin.Context) { CreateQuestion(c, db) })
			courses.GET("/quizzes/:id/questions", func(c *gin.Context) { GetQuizQuestions(c, db) })
			courses.POST("/quizzes/:id/start", middleware.RoleMiddleware(models.RoleStudent), func(c *gin.Context) { StartQuizAttempt(c, db) })
			courses.GET("/quizzes/:id/attempts", middleware.RoleMiddleware(models.RoleStudent), func(c *gin.Context) { GetStudentAttempts(c, db) })
			...
			// Course-specific routes with :id for sub-resources
			courses.POST("/:id/enroll", middleware.RoleMiddleware(models.RoleStudent), func(c *gin.Context) { EnrollStudent(c, db) })
			courses.DELETE("/:id/unenroll", middleware.RoleMiddleware(models.RoleStudent), func(c *gin.Context) { UnenrollStudent(c, db) })
			courses.GET("/:id/enrollments", middleware.RoleMiddleware(models.RoleInstructor, models.RoleAdmin), func(c *gin.Context) { GetCourseEnrollments(c, db) })
			courses.GET("/:id/enrollment-status", func(c *gin.Context) { GetEnrollmentStatus(c, db) })
			courses.GET("/:id/stats", func(c *gin.Context) { GetEnrollmentStats(c, db) })
			courses.POST("/:id/modules", middleware.RoleMiddleware(models.RoleInstructor, models.RoleAdmin), func(c *gin.Context) { CreateModule(c, db) })
			courses.GET("/:id/modules", func(c *gin.Context) { GetCourseModules(c, db) })
			courses.POST("/:id/assignments", middleware.RoleMiddleware(models.RoleInstructor, models.RoleAdmin), func(c *gin.Context) { CreateAssignment(c, db) })
			courses.GET("/:id/assignments", func(c *gin.Context) { GetCourseAssignments(c, db) })
			courses.POST("/:id/quizzes", middleware.RoleMiddleware(models.RoleInstructor, models.RoleAdmin), func(c *gin.Context) { CreateQuiz(c, db) })
			courses.GET("/:id/quizzes", func(c *gin.Context) { GetCourseQuizzes(c, db) })
			courses.POST("/:id/announcements", middleware.RoleMiddleware(models.RoleInstructor, models.RoleAdmin), func(c *gin.Context) { CreateAnnouncement(c, db) })
			courses.GET("/:id/announcements", func(c *gin.Context) { GetCourseAnnouncements(c, db) })
			courses.POST("/:id/discussions", func(c *gin.Context) { CreateDiscussion(c, db) })
			courses.GET("/:id/discussions", func(c *gin.Context) { GetCourseDiscussions(c, db) })
			courses.GET("/:id/grades", func(c *gin.Context) { GetCourseGrades(c, db) })
			courses.GET("/:id/my-grades", middleware.RoleMiddleware(models.RoleStudent), func(c *gin.Context) { GetStudentGrades(c, db) })
			courses.GET("/:id/certificate", middleware.RoleMiddleware(models.RoleStudent), func(c *gin.Context) { GetCertificate(c, db) })

			// Generic course operations (MUST BE LAST - catch-all for /courses/:id endpoints)
